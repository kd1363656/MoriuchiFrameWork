...
void StaticModelComponent::Draw(const Render3DCommonComponent::DrawType DrawType) const
{
...
void StaticModelComponent::Draw(const Render3DCommonComponent::ShaderType ShaderType) const
{
...
void StaticModelComponent::LoadPrefabData(const nlohmann::json& Json)
{
	...
	if (Json.contains("Render3DComponent"     )) { m_render3DCommonComponent.LoadPrefabData       (Json["Render3DComponent"     ]); }
...
nlohmann::json StaticModelComponent::SavePrefabData()
{
	...
	json_["Render3DComponent"     ] = m_render3DCommonComponent.SavePrefabData       ();
